...
if 'mode' not in st.session_state: st.session_state.mode = "READY" # READY, WORKING, PAUSE
...
# --- LOGIK: WORKING MODE (15-20 Min) ---
    ...
    if st.button("✅ ERLEDIGT!") or remaining <= 0:
        ...
        st.session_state.start_time = time.time() # Reset für Pause
...
# --- LOGIK: PAUSE MODE (10 Min) ---
    ...
    st.warning(f"Noch {int(remaining_pause//60):02d}:{int(remaining_pause%60):02d} Minuten ausruhen.")
